 ...
 */
export async function listProdutosService(filters?: { query?: string; categoriaId?: number; ativo?: boolean }): Promise<ProdutoListItemEntity[]> {
  return await listProdutosRepository(filters);
}
