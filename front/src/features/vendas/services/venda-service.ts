 ...
 */
export async function listVendasService(filters?: { dataInicio?: string; dataFim?: string; clienteId?: number; status?: string }): Promise<VendaListItemEntity[]> {
  return await listVendasRepository(filters);
}
