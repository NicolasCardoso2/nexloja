// Carrinho da tela de Nova Venda.
// Não salva no localStorage some quando finaliza ou cancela a venda,
// o que faz sentido já que é uma operação de uma sessão só.
//
// Comportamento importante:
//   - Escanear/adicionar o mesmo produto duas vezes só sobe a quantidade
//   - Colocar quantidade 0 remove o item sozinho
//   - subtotal = quantidade × preco_unitario (atualizado automaticamente)
