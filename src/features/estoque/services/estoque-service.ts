 ...
 */
export async function listEstoqueService(): Promise<EstoqueItemEntity[]> {
  return await listEstoqueRepository();
}
 ...
 */
export async function listMovimentacoesEstoqueService(): Promise<MovimentacaoEstoqueEntity[]> {
  return await listMovimentacoesEstoqueRepository();
}
